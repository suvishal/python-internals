...
Python doesn't create a box called x containing 10. It creates an integer object 10 somewhere in memory, and x is a name that points to it. That object internally tracks one number: how many things currently point to it.
        ...
        a = [1, 2, 3]   # the list object's ref count → 1
...
|Tool|Answers|
|--|--|
|**sys.getrefcount()**                | "How many things point at this object right now?"|
|**gc.get_objects() / gc.collect()**  | "Are there cycles, and can I force-clean them?"|
|**tracemalloc**                      | "Which line of code allocated this memory?"|
|**objgraph**                         | "What's the reference chain keeping this object alive?"|
